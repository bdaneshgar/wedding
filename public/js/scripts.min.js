...
$(document).ready(function () {
  ...
  $("a[href*=#]:not([href=#])").click(function () {
    if (
      ...
      if (e.length) {
        $("html,body").animate({ scrollTop: e.offset().top - 90 }, 2000);
        return false;
      }
    }
  });
  ...
  for (var n = 0; n < e.length; n++) {
    var o =
      ...
      '&amp;via=ramswarooppatra&amp;hashtags=ramandantara&amp;count=horizontal" style="width:105px; height:21px;"></iframe>' +
  ...
  // remove YouTube background video (YTPlayer)
  // $(".player").YTPlayer();  ← removed
